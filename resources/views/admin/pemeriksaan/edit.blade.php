...
<div class="card">
    ...
    <div class="card-body">
        <form action ="/pemeriksaan/{{ $pemeriksaans->id }}" method="post">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
            <div class="mb-3">
                ...
                <select class="form-select" name="antrian_id" aria-label="Default select example">
                    ...
                    @foreach($antrians as $antrian)
                        @if (old('antrian_id',$pemeriksaans->antrian_id) == $antrian->id)
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="pasien_id" aria-label="Default select example">
                    ...
                    @foreach($pasiens as $pasien)
                        @if (old('pasien_id',$pemeriksaans->pasien_id) == $pasien->id)
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('suhu_badan') is-invalid @enderror" id="suhu_badan" name="suhu_badan" value="{{old('suhu_badan',$pemeriksaans->suhu_badan)}}"  autofocus>
                    @error('suhu_badan')
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('tekanan_darah') is-invalid @enderror" id="tekanan_darah" name="tekanan_darah" value="{{old('tekanan_darah',$pemeriksaans->tekanan_darah)}}"  autofocus>
                    @error('tekanan_darah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('keluhan') is-invalid @enderror" id="keluhan" name="keluhan" value="{{old('keluhan',$pemeriksaans->keluhan)}}"  autofocus>
            @error('keluhan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            <label for="status_pemeriksaan" class="form-label">Status Pemeriksaan</label>
            <select class="form-select" name="status_pemeriksaan" aria-label="Default select example">
                <option selected>Status</option>
                <option value="belum" 
                @if ($pemeriksaans['status_pemeriksaan']=="belum")
                    {{ 'selected' }}
                @endif>Belum</option>
                <option value="selesai" @if ($pemeriksaans['status_pemeriksaan']=="selesai"){{ 'selected' }}@endif>Selesai</option>
