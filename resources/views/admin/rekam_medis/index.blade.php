...
@section('container')
    ...
    <a href="/rekam-medis/create" type="button" class="btn btn-primary">Rekam Medis</a>
              ...
              <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $rm->pemeriksaan->kode_pemeriksaan }}</td>
                        <td>{{ $rm->dokter->nama_dokter }}</td>
                        <td>{{ $rm->diagnosa}}</td>
                        <td>{{ $rm->tindakan}}</td>
                        <td>{{ $rm->rujukan}}</td>
                        <td>
                            <a href="/rekam-medis/{{ $rm->id }}/edit" class="btn btn-warning mb-1">Edit</a>
 ...
 --}}
      ...
      {{ $rekam_medis  ->links('pagination::bootstrap-5') }}
