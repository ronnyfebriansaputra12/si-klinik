...
@section('container')
    ...
    <a href="/pasiens/create" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">Tambah Data Pasien</a>
              ...
              <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/pasiens/{{ $pasien->id }}/edit" class="btn btn-warning">Edit</a>
    
                            <form action="/pasiens/{{ $pasien->id }}" method="post" class="d-inline">
                                @method('DELETE')
                            @csrf
