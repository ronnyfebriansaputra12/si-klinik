...
@section('container')
    ...
    <a href="/antrian/create" type="button" class="btn btn-primary">Tambah Antrian</a>
              ...
              <div class="card-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $antrian->tanggal_checkup }}</td>
                        <td>
                            @if ($antrian->status_antrian == "menunggu")
                                <a href="/antrian/{{ $antrian->id }}/diperiksa" onclick="return confirm('Yakin Akan Mengubah Status Antrian..?')" class="btn btn-dark btn-sm">Menunggu</a>
                            @elseif($antrian->status_antrian == "diperiksa")
                                <button class="btn btn-success btn-sm">Selesai Di Periksa</button>
                            @endif
                        </td>
                        
                        <td>
                            <a href="/antrian/{{ $antrian->id }}/edit" class="btn btn-warning">Edit</a>
            ...
            <form action ="/antrian" method="post">
              @csrf
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control @error('nama_dokter') is-invalid @enderror" id="nama_dokter" name="nama_dokter" value="{{old('nama_dokter')}}" required autofocus>
                  @error('nama_dokter')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('umur') is-invalid @enderror" id="umur" name="umur" value="{{old('umur')}}" required autofocus>
                @error('umur')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" name="no_hp" value="{{old('no_hp')}}" required autofocus>
                @error('no_hp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
