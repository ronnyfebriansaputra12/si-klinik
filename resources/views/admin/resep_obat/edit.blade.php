...
<div class="card">
    ...
    <div class="card-body">
        <form action ="/resep-obat/{{ $resep_obat->id }}" method="post">
            @method('PUT')
            @csrf
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="rekam_medis_id" aria-label="Default select example">
                    ...
                    @foreach($rekam_medis as $rm)
                        @if (old('rekam_medis_id',$resep_obat->rekam_medis_id) == $rm->id)
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="obat_id" aria-label="Default select example">
                            ...
                            @foreach($obats as $obat)
                                @if (old('obat_id',$resep_obat->obat_id) == $obat->id)
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('jumlah_obat') is-invalid @enderror" id="jumlah_obat" name="jumlah_obat" value="{{old('jumlah_obat',$resep_obat->jumlah_obat)}}"  autofocus>
                    @error('jumlah_obat')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" value="{{old('keterangan',$resep_obat->keterangan)}}"  autofocus>
            @error('keterangan')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
